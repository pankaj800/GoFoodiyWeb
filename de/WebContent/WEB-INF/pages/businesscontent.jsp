...
<div class="wrapper">
  ...
  <div class="content-wrapper">
    ...
    <!--<div style="width: 800px;height:60px;background-color: white;border-radius:2px;border-top-color:#00c0ef">  -->
      <div class="box box-info" style="border-top-width:8px">
    ...
    <section class="content container-fluid">
      ...
      <!--------------------------
        ...
        -------------------------->
        <div id="menusId" ng-if="menuflag"><jsp:include page="../pages/menus.jsp"></jsp:include></div>
        
 <div id="detailsId" ng-if="detailsflag"><jsp:include page="../pages/details.jsp"></jsp:include></div>
<div id="dishesId" ng-if="dishesflag"><jsp:include page="../pages/dishes.jsp"></jsp:include></div>
