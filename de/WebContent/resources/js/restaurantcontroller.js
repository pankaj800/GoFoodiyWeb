...
loginApp.controller('restaurantcontroller', function($scope,$http,$rootScope,$window) {
	...
	$scope.getPossibleCityName=function(){
		 $scope.cityArray=[];
		var i;
		var cityName=angular.element(document.querySelector('#citysearchTermId3')).val();
